...
@section('Panza')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex justify-center mt-8 space-x-4">
            <a href="{{ route('Inscripcion.create') }}"
                class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded shadow-md">Matricular Estudiante</a>
        </div>
        ...
        <div class="mt-8 overflow-x-auto" id="tableContainer">
            @include('VistaInscripcion.table')
        </div>
    </div>
    ...
    <script>
        ...
        document.getElementById('searchForm').addEventListener('submit', function(event) {
            ...
            axios.get('{{ route('Inscripcion.index') }}', {
                    params: {
                        search: searchValue,
                        fecha: fechaValue
                    }
